...
def qn_4():
    ...
    WHERE Teams_in_Matches.Unique_Team_ID = Unique_Teams.Unique_Team_ID """,con)
...
def qn_4_():
    ...
    JOIN Unique_Teams
    ON Teams_in_Matches.Unique_Team_ID = Unique_Teams.Unique_Team_ID """,con)
    df = pd.DataFrame(qn_4_query)
    print(df)
...
def qn_7():
    ...
    SELECT MAX(Teams_in_Matches.Match_ID), Teams_in_Matches.Unique_Team_ID, Unique_Teams.TeamName
    FROM Teams_in_Matches
    JOIN Unique_Teams
